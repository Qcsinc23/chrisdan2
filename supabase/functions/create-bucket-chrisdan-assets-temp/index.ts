...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/*", "application/pdf", "text/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for chrisdan-assets" ON storage.objects FOR SELECT USING (bucket_id = 'chrisdan-assets');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for chrisdan-assets" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'chrisdan-assets');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for chrisdan-assets" ON storage.objects FOR UPDATE USING (bucket_id = 'chrisdan-assets');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for chrisdan-assets" ON storage.objects FOR DELETE USING (bucket_id = 'chrisdan-assets');`
    ];
