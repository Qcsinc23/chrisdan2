    ...
    try {
      ...
      if (data.user) {
        ...
        if (data.user && !data.session) {
          navigate('/customer/login?message=Please check your email to verify your account')
        } else {
          // For instant login (if email confirmation is disabled), redirect to dashboard
