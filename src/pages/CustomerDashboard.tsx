...
export default function CustomerDashboard() {
  ...
  // Show account setup message only if customer account doesn't exist and not on settings page
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">Please complete your customer profile to access all dashboard features</p>
              <Link
